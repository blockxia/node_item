 ...
 * 1. 通过在 sxx-module 中 npm init --yes 来生成 package.json 文件
 * 2. package.json 文件中告诉了程序入口文件为 ："main": "tools.js",
 * 3. Node 通过 require 查找 sxx-module，发现它有个 package.json
 * 4. Node 执行 tools.js 文件
 */
 var tools3 = require('sxx_module');
